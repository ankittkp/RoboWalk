...
//----------------Bridge-----------
	...
	if(mov_z>2250&&mov_z<2350&&mov_x>-100&&mov_x<100&&key_main_get==0)
	{
		key_main_get=1;
		glutTimerFunc(1,Time,0);
	}
